...
## 1. 粘液科技指南 {#1-slimefun-guide}

在游玩的过程中，你需要的第一件物品就是粘液科技指南。
你可以通过指令`/sf guide`获取它，右键点击这本书以打开。
你将看到粘液科技提供的所有分类。
在每个分类中，你可以找到由粘液科技或附属插件添加的物品。
你可以点击任何物品来查看其配方。
花一点时间，好好浏览一下这本指南吧。

## 2. 研究 {#2-researching}

你会注意到许多的粘液科技物品都被锁定了（这取决于服务器的设置）。
...
这是你需要建造的第一个机器。
你必须在一个发射器上方放置一个工作台。
大部分粘液科技配方是通过在发射器中按顺序摆放，然后右键点击工作台来建造的。
你可以在[这里](./items/Enhanced-Crafting-Table)获取更多有关此机器的信息。

## 5. 收集矿粉 {#5-collecting-dust}

许多配方需要各种锭或合金。
你需要在[增强型工作台](./items/Enhanced-Crafting-Table)中制造一个[淘金盘](./items/Gold-Pan)。
手持[淘金盘](/Gold-Pan)，右键点击沙砾，你会得到[筛矿](./items/Sifted-Ore)。
然后，制造一个[洗矿机](./items/Ore-Washer)来处理这些[筛矿](./items/Sifted-Ore)。
你会得到大量的矿粉（比如铜、锡、锌等）。拿起这些矿粉，然后进入第6步。

## 6. 冶炼炉 {#6-the-smeltery}

现在，该让这些矿粉变为锭了。
制造一个[冶炼炉](./items/Smeltery)，并将矿粉冶炼成锭或合金。
你将在大量配方中用到这些锭或者合金。

## 7. 玩得开心 {#7-enjoy-the-plugin}

现在，我们已经告诉你玩粘液科技必须知道的基础知识。
玩得开心，享受你的冒险之旅吧！
