...
* **你的粘液科技版本** *(你安装了什么版本? 是开发版还是稳定版?)*

你可以通过指令 `/sf versions` 收集到这些信息。  
如果你的服主没有给你这条指令权限，按下 Shift 并右键打开粘液科技指南，在左上角，它至少告诉你 Minecraft 与粘液科技的版本。
...
需要注意的是，包含 "slimefun" 字样，或直接说是由粘液科技引起的堆栈追踪，可能并不是由粘液科技引起的。  
...
当你遇到粘液科技出现问题时，请确保物品/方块/机器确实来自 Slimefun，而不是来自附属插件。  
如果你的问题与 ExoticGarden 或其他粘液科技附属插件有关，请将问题汇报至对应附属插件的问题追踪器中，而不是这里。
